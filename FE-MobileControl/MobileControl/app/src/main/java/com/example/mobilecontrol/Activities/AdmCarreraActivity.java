...
public class AdmCarreraActivity extends AppCompatActivity implements RecyclerItemTouchHelper.RecyclerItemTouchHelperListener, CarreraAdapter.CarreraAdapterListener {
   ...
   // String apiUrl = "http://10.20.105.143:8080/BE-LabConnection/ServiceCarrera?";
    String apiUrl = "http://10.20.106.109:8080/BE-LabConnection/ServiceCarrera?";
    ...
    public class MyAsyncTasks extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                mAdapter = new CarreraAdapter(carreraList, AdmCarreraActivity.this);
