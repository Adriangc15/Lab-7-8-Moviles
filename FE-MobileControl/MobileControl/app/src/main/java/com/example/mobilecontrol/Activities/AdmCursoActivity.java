    ...
    private void checkIntentInformation() {
        ...
        if (extras != null) {
            ...
            if (aux == null) {
                ...
                if (aux != null) {
                    apiUrlTemporal = apiUrl + "opc=4&codigo="+aux.getCodigo()+"&codigoCiclo="+aux.getCodigo_ciclo()+"&codigoCarrera="+aux.getCodigo_carrera()+"&nombre="+aux.getNombre()+"&creditos="+aux.getCreditos()+"&horas="+aux.getHoras();
                    MyAsyncTasks myAsyncTasks = new MyAsyncTasks();
                    myAsyncTasks.execute();
                    Toast.makeText(getApplicationContext(), aux.getNombre() + " editado correctamente", Toast.LENGTH_LONG).show();
                }
            }else{
                apiUrlTemporal = apiUrl + "opc=2&codigo="+aux.getCodigo()+"&codigoCiclo="+aux.getCodigo_ciclo()+"&codigoCarrera="+aux.getCodigo_carrera()+"&nombre="+aux.getNombre()+"&creditos="+aux.getCreditos()+"&horas="+aux.getHoras();
                MyAsyncTasks myAsyncTasks = new MyAsyncTasks();
                myAsyncTasks.execute();
